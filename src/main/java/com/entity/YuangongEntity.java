...
public class YuangongEntity<T> implements Serializable {
	 ...
	 * 设置：事务所名称
	 */
	public void setShiwusuomingcheng(String shiwusuomingcheng) {
		this.shiwusuomingcheng = shiwusuomingcheng;
	}
	/**
	 * 获取：事务所名称
	 */
	public String getShiwusuomingcheng() {
		return shiwusuomingcheng;
	}
	/**
	 * 设置：身份证
	 */
