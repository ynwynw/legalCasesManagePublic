  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="律师姓名" prop="lvshixingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="等级" prop="dengji">
          <el-input v-model="ruleForm.dengji"               placeholder="等级" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='yuangong'"  label="事务所名称" prop="shiwusuomingcheng">
          <el-select v-model="ruleForm.shiwusuomingcheng"  placeholder="请选择事务所名称">
            <el-option
                v-for="(item,index) in yuangongshiwusuomingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  data() {
    return {
      ...
      yuangongshiwusuomingchengOptions: [],
    };
  },
  mounted() {
    ...
    this.$http({
      url: `option/shiwusuoxinxi/shiwusuomingcheng`,
      method: "get"
    }).then(({ data }) => {
      if (data && data.code === 0) {
        this.yuangongshiwusuomingchengOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
